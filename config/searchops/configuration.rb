  ...
  class Configuration
    ...
    DEFINITIONS = {
      ...
      oauth_http_safe_retries: Definition.new("SEARCHOPS_OAUTH_HTTP_SAFE_RETRIES", :integer,
        2, 0, 3, nil, false, nil),
      oauth_jwks_cache_ttl: Definition.new("SEARCHOPS_OAUTH_JWKS_CACHE_TTL", :duration, "5m",
        60, 21_600, nil, false, nil),
      oauth_jwks_max_keys: Definition.new("SEARCHOPS_OAUTH_JWKS_MAX_KEYS", :integer,
        16, 1, 32, nil, false, nil),
      oauth_oidc_clock_skew: Definition.new("SEARCHOPS_OAUTH_OIDC_CLOCK_SKEW", :duration, "60s",
        0, 300, nil, false, nil),
      oauth_oidc_max_token_lifetime: Definition.new("SEARCHOPS_OAUTH_OIDC_MAX_TOKEN_LIFETIME", :duration, "2h",
        300, 7200, nil, false, nil),
      oauth_transaction_ttl: Definition.new("SEARCHOPS_OAUTH_TRANSACTION_TTL", :duration, "10m",
        60, 900, nil, false, nil),
      oauth_transaction_retention: Definition.new("SEARCHOPS_OAUTH_TRANSACTION_RETENTION", :duration, "24h",
        900, 604_800, nil, false, nil),
      oauth_start_rate_window: Definition.new("SEARCHOPS_OAUTH_START_RATE_WINDOW", :duration, "5m",
        60, 3600, nil, false, nil),
      oauth_start_max_per_ip: Definition.new("SEARCHOPS_OAUTH_START_MAX_PER_IP", :integer,
        20, 1, 1000, nil, false, nil),
      oauth_start_max_per_session: Definition.new("SEARCHOPS_OAUTH_START_MAX_PER_SESSION", :integer,
        10, 1, 1000, nil, false, nil),
      oauth_start_max_open_per_ip: Definition.new("SEARCHOPS_OAUTH_START_MAX_OPEN_PER_IP", :integer,
        5, 1, 100, nil, false, nil),
      oauth_start_max_open_per_session: Definition.new("SEARCHOPS_OAUTH_START_MAX_OPEN_PER_SESSION", :integer,
        2, 1, 100, nil, false, nil),
      auth_callback_failure_rate_window: Definition.new("SEARCHOPS_AUTH_CALLBACK_FAILURE_RATE_WINDOW", :duration,
        "5m", 60, 3600, nil, false, nil),
      auth_callback_failure_max_per_ip: Definition.new("SEARCHOPS_AUTH_CALLBACK_FAILURE_MAX_PER_IP", :integer,
        10, 1, 1000, nil, false, nil),
      auth_session_action_rate_window: Definition.new("SEARCHOPS_AUTH_SESSION_ACTION_RATE_WINDOW", :duration,
        "5m", 60, 3600, nil, false, nil),
      auth_session_action_max_per_session: Definition.new("SEARCHOPS_AUTH_SESSION_ACTION_MAX_PER_SESSION", :integer,
        30, 1, 1000, nil, false, nil),
      auth_account_security_rate_window: Definition.new("SEARCHOPS_AUTH_ACCOUNT_SECURITY_RATE_WINDOW", :duration,
        "5m", 60, 3600, nil, false, nil),
      ...
      crawler_dns_timeout: Definition.new("SEARCHOPS_CRAWLER_DNS_TIMEOUT", :duration, "3s",
        0.1, 10, nil, false, nil),
      crawler_connect_timeout: Definition.new("SEARCHOPS_CRAWLER_CONNECT_TIMEOUT", :duration, "5s",
        0.1, 60, nil, false, nil),
      crawler_tls_timeout: Definition.new("SEARCHOPS_CRAWLER_TLS_TIMEOUT", :duration, "5s",
        0.1, 60, nil, false, nil),
      crawler_header_timeout: Definition.new("SEARCHOPS_CRAWLER_HEADER_TIMEOUT", :duration, "10s",
        0.1, 60, nil, false, nil),
      crawler_read_timeout: Definition.new("SEARCHOPS_CRAWLER_READ_TIMEOUT", :duration, "20s",
        1, 300, nil, false, nil),
      crawler_total_timeout: Definition.new("SEARCHOPS_CRAWLER_TOTAL_TIMEOUT", :duration, "45s",
        1, 600, nil, false, nil),
      crawler_max_header_bytes: Definition.new("SEARCHOPS_CRAWLER_MAX_HEADER_BYTES", :integer, 65_536,
        1024, 262_144, nil, false, nil),
      ...
      crawler_max_decompressed_bytes: Definition.new(
        "SEARCHOPS_CRAWLER_MAX_DECOMPRESSED_BYTES", :integer, 26_214_400,
        1024, 524_288_000, nil, false, nil
      ),
      crawler_max_decompression_ratio: Definition.new(
        "SEARCHOPS_CRAWLER_MAX_DECOMPRESSION_RATIO", :integer, 100, 1, 1000, nil, false, nil
      ),
      crawler_max_redirects: Definition.new("SEARCHOPS_CRAWLER_MAX_REDIRECTS", :integer, 5, 0, 20, nil, false, nil),
      crawler_safe_retries: Definition.new("SEARCHOPS_CRAWLER_SAFE_RETRIES", :integer, 2,
        0, 5, nil, false, nil),
      crawler_retry_base_delay: Definition.new("SEARCHOPS_CRAWLER_RETRY_BASE_DELAY", :duration, "250ms",
        0.1, 10, nil, false, nil),
      crawler_retry_max_delay: Definition.new("SEARCHOPS_CRAWLER_RETRY_MAX_DELAY", :duration, "5s",
        0.1, 30, nil, false, nil),
      ...
      dns_verification_enabled: Definition.new("SEARCHOPS_DNS_VERIFICATION_ENABLED", :boolean,
        true, nil, nil, nil, false, nil),
      dns_verification_timeout: Definition.new("SEARCHOPS_DNS_VERIFICATION_TIMEOUT", :duration,
        "3s", 0.1, 10, nil, false, nil),
      dns_verification_max_records: Definition.new("SEARCHOPS_DNS_VERIFICATION_MAX_RECORDS", :integer,
        32, 1, 100, nil, false, nil),
      dns_verification_max_response_bytes: Definition.new(
        "SEARCHOPS_DNS_VERIFICATION_MAX_RESPONSE_BYTES", :integer, 4096, 256, 65_536, nil, false, nil
      ),
      dns_verification_max_cname_hops: Definition.new("SEARCHOPS_DNS_VERIFICATION_MAX_CNAME_HOPS", :integer,
        5, 0, 10, nil, false, nil),
      dns_verification_max_delegations: Definition.new("SEARCHOPS_DNS_VERIFICATION_MAX_DELEGATIONS", :integer,
        8, 0, 32, nil, false, nil),
      http_verification_enabled: Definition.new("SEARCHOPS_HTTP_VERIFICATION_ENABLED", :boolean,
        true, nil, nil, nil, false, nil),
      verification_http_dns_timeout: Definition.new("SEARCHOPS_VERIFICATION_HTTP_DNS_TIMEOUT", :duration,
        "3s", 0.1, 10, nil, false, nil),
      verification_http_open_timeout: Definition.new("SEARCHOPS_VERIFICATION_HTTP_OPEN_TIMEOUT", :duration,
        "2s", 0.1, 10, nil, false, nil),
      verification_http_read_timeout: Definition.new("SEARCHOPS_VERIFICATION_HTTP_READ_TIMEOUT", :duration,
        "5s", 0.1, 30, nil, false, nil),
      verification_http_max_response_bytes: Definition.new(
        "SEARCHOPS_VERIFICATION_HTTP_MAX_RESPONSE_BYTES", :integer, 262_144, 128, 1_048_576, nil, false, nil
      ),
      verification_http_max_redirects: Definition.new("SEARCHOPS_VERIFICATION_HTTP_MAX_REDIRECTS", :integer,
        2, 0, 5, nil, false, nil),
