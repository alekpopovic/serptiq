...
module Auditing
  class MetadataSanitizer
    ...
    ALLOWED_KEYS = %w[
      change_count changed_fields entitlement from operation previous_version principal_type provider reason_code
      revoke_reason principal_id revoked_count role_id scope_id scope_type source status subscriber_count to
    ].freeze
