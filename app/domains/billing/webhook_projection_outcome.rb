...
module Billing
  WebhookProjectionOutcome = Data.define(
    :result, :organization_id, :subscription_id, :canonical_changed, :outbox_event_ids
  ) do
    def initialize(result:, organization_id: nil, subscription_id: nil, canonical_changed: false,
      ...
      super(
        ...
        outbox_event_ids: Array(outbox_event_ids).map { |id| normalize_uuid(id, "outbox event") }.freeze
      )
      freeze
    end
