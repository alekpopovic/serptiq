...
module Usage
  class ManualAdjustmentAuthorizer
    def call(organization_id:, actor_membership:, authorization:)
      ...
      raise AccessDenied.new(reason_code: "usage_adjustment_platform_authority_required") unless allowed
