...
| Crawler limits | URL, byte, redirect and request concurrency bounds; per-project/global scan caps; frontier lease batch/duration, persisted attempt cap and retry base delay; connect/read duration bounds | none |
