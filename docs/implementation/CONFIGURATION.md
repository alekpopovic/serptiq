...
| OAuth providers | enable flags, client IDs, bounded HTTP timeouts/response size and safe discovery/JWKS retries | client secrets; later token records use database encryption |
