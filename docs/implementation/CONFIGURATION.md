...
| Crawler limits | URL, byte, redirect and request concurrency bounds; per-project/global scan caps; frontier lease batch/duration, persisted attempt cap and retry base delay; connect/read duration bounds; dedicated robots DNS/open/read deadlines, 500 KiB-or-higher response cap and at-most-five redirects | none |
